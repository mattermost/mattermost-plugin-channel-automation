...
- **User Joined Team** — Fire a flow when a user joins the configured team. Optionally filter by user type (regular users or guests). Provides user info and the team's default channel.
