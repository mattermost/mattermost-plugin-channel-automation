...
ifneq ($(HAS_SERVER),)
	...
	mockgen -destination=server/command/mocks/mock_commands.go -package=mocks github.com/mattermost/mattermost-plugin-channel-automation/server/command Command
endif
