...
- "message_posted": fires when a message is posted in the channel, including bot and webhook posts. Posts from the default automation bot and AI-generated agent replies are filtered to reduce self-triggered loops. High-traffic channels will trigger frequently.
