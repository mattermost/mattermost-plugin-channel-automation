...
// ExecutionRecord captures the result of a completed automation execution.
...
type ExecutionStore interface {
	...
	ListByAutomation(automationID string, limit int) ([]*ExecutionRecord, error)
	ListRecent(limit int) ([]*ExecutionRecord, error)
	PurgeAutomation(automationID string) error
}
